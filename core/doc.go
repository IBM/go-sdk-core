...
OpenAPI 3 SDK Generator (openapi-sdkgen). Go code generated by openapi-sdkgen
will depend on the function contained in this project.
...
Services are the API clients generated by the by the IBM OpenAPI 3 SDK
Generator. These services make use of the code within the core package
and most notably extend the BaseService struct.
